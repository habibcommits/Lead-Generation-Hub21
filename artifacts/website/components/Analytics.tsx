...
export default function Analytics() {
  ...
  return (
    <>
      {/* Google Analytics 4 — set NEXT_PUBLIC_GA4_ID in env (e.g. G-XXXXXXXXXX) */}
      {ga4Id && (
        <>
          <Script
      ...
      {/* Plausible Analytics — set NEXT_PUBLIC_PLAUSIBLE_DOMAIN in env (e.g. yourdomain.com) */}
      {plausibleDomain && (
        <Script
          defer
      ...
      {/* PostHog — set NEXT_PUBLIC_POSTHOG_KEY and NEXT_PUBLIC_POSTHOG_HOST in env */}
      {posthogKey && (
